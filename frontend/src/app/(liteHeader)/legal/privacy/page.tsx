    ...
    return (
        <div className={`p-6 md:p-14 md:pt-24 lg:w-4/5 ${styles.privacy}`}>
            ...
            <div>
                ...
                <ul>
                    <li>Visit our website at tastyplan.de</li>
            ...
            <div>
                ...
                <ul>
                    <li>
                        <strong> "Website"</strong>," we are referring to any website of ours that references or
                        InTextLinks to this policy
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul>
                    <li>
                        <strong>Personal Information Provided by you.</strong> We collect names; email addresses;
                    ...
                    <li>
                        ...
                        using your existing social media account details, like your Twitter and GitHub account. If you
            ...
            <div>
                ...
                <ul>
                    <li>
                        <strong>To facilitate account creation and login process.</strong> If you choose to InTextLink
                        your account with us to a third-party account (such as your Twitter or Github account), we use
                        the information you allowed us to collect from those third parties to facilitate account
                        creation and login process for the performance of the contract. See the section below headed
                        "how do we handle your social logins" for further information.
                    </li>
                    <li>
                        <strong>Request feedback.</strong> We may use your information to request feedback and to
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <strong>Legitimate Interests:</strong> We may process your data when it is reasonably 􏰀
            ...
            <div>
                ...
                <p>
                    We do not use cookies or similar tracking technologies (like web beacons and pixels) to access or
                    store information. We integrated the tool plausible into our website. However, we are using a
                    self-hosted instance so no data leaves our infrastructure.
                </p>
                <h3>Functional cookies</h3>
                <p>
                    We use a functional session cookie called "tastyplan-session" to handle the login process and
                    assigning submissions to a user.
                </p>
            </div>
            ...
            <div>
                ...
                <p>
                    ...
                    either delete or anonymize such information, or, if this is 􏰀 not possible (for example, because
            ...
            <div>
                ...
                <p>
                    ...
                    circumstances. To request to review, update, or delete your personal information, please send us an
                    email.
                </p>
            </div>
        </div>
