    ...
    <div className={`${styles.overlayContainer} ${visible && styles.rightPanel}`}>
              <div className={styles.overlay}>
                  <div className={styles.overlayLeft}>
                      ...
                      <br />
                      <button className="btn-secondary" onClick={handleToggle} id="login">Sign In</button>
                  </div>
                  <div className={styles.overlayRight}>
                      <h2>Welcome Back!</h2>
                      <p>Don`t have have an account ? </p>
                      <br/>
                      <button className="btn-secondary" onClick={handleToggle} id="registration">Sign Up</button>
                  </div>
              </div>
          </div>
  )
