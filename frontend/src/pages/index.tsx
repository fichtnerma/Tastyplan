        ...
        <div className="w-full mt-[-20px]">
            ...
            <div className='mb-40 mt-10 flex'>
                ...
                <div className='w-4/5'>
                    ...
                    <p className='text-justify'>No more worrying about what to eat for the week or spending hours scouring the internet for recipes.
            ...
            <div className='mb-40 mt-10 flex'>
                ...
                <div className='w-4/5'>
                    ...
                    <p className='text-justify mb-2'>1. Sign up for an account.
                    </p>
                    <p className='text-justify mb-2'>2. Set up your account by entering your dietary preferences, food allergies, and food dislikes. This will help Tastyplan generate a personalized meal plan for you.
                    </p>
                    <p className='text-justify mb-2'>3. Once you've set up your account, Tastyplan will generate a weekly meal plan for you, complete with recipes and a shopping list.
                    </p>
                    <p className='text-justify mb-2'>4. Head to the grocery store to get everything you need for the week.
                    </p>
                    <p className='text-justify mb-2'>5. Follow the recipes provided by Tastyplan to prepare your meals for the week.
                    </p>
                    <p className='text-justify mb-2'>6. Enjoy delicious and hassle-free meal planning with Tastyplan!
                    </p>
                </div>
