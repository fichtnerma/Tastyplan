            ...
            <div className={styles.container}>
                ...
                <div className='flex mt-10'>
                    ...
                    <Swiper
                        ...
                        modules={[Navigation, Scrollbar, Mousewheel]} className={styles.mySwiper}>
                                ...
                                <div className='mr-12'>
                                    ...
                                    <Link href={`/recipe/${day.recipe.id}`}>
                                        <div className={styles.wrapperContainer}>
                                            ...
                                            >
                                                <div className={
                                                    (day.recipe.name.length >= 20) ? `${styles.discriptionFood} ${styles.twoLinesName}` :
                                                        styles.discriptionFood}>
                                                    <div className='h-16 absolute bottom-0'>
                                                        <p className='text-2xl w-56 absolute bottom-0'
                                                    ...
                                                    <div className={styles.discriptionHover}>
                                                        ...
                                                        {day.recipe.formOfDiet !== null &&
                                                            <div className='flex flex-row gap-x-2'>
                                                                <Image src={getFormOfDietIcon(day.recipe)} alt="Time Icon" className='mb-4' width={20} height={20} priority />
                                                                <p className='text-base mb-4'
